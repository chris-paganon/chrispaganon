...
I built and tested **physical prototypes** working with wood, metal, and composites. This involved using a wide range of tools and machines, from traditional woodworking and metalworking equipment to a **CNC router** for precision manufacturing. Each prototype went through multiple iterations based on test results and real-world feedback.

### Trade Show Participation

I also represented the company at trade shows, building our booth from scratch and supporting the sales team on the floor. This gave me direct exposure to customer needs and market feedback, which often fed back into design improvements.
