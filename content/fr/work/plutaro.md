---
Title: Plutaro
Description: Agence orientée IA construisant des applications React, des produits IA et gérant des équipes d'ingénierie sur plus de 20 projets
id: 10
slug: plutaro
...
Depuis août 2024, je dirige le développement chez Plutaro, une agence spécialisée dans les applications web, les projets IA et le mobile.

J'ai **construit plus de 10 applications en production** avec React, Next.js et React Native, tout en **gérant des ingénieurs juniors et coordonnant des projets complexes**. Je travaille sur un mélange de livrables clients et de produits internes d'outillage IA.

### Produits IA Internes
...
Au-delà du développement pratique, je dirige le cycle de vie complet des projets complexes :

- **Planning et Échéancier** : Décomposition des exigences en jalons et livrables actionnables
- **Assurance Qualité** : Établissement de protocoles de test et révision de la qualité du code
- **Stratégie de Déploiement** : Coordination des calendriers de release et des déploiements en production
- **Gestion d'Équipe** : Mentorat de 2-3 ingénieurs juniors, revues de code et établissement de standards de développement
- **Coordination d'Équipe** : Révision des exigences et déblocage des défis techniques
