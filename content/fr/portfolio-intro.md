...
**Développeur web autodidacte depuis 2016**, j'ai réalisé mon premier site web pour un projet universitaire sur l'impression 3D. J'ai développé et géré plusieurs sites web et travaillé dans des **agences de développement web à Montréal**. Mon expertise couvre le **développement frontend et backend**, y compris les single page applications en VueJS, Typescript, React, les sites WordPress, les backends en PHP, generative AI, Python, les bases de données SQL et GitHub/GitLab DevOps...

J'ai également effectué des missions en freelance pour [Batimatech](/project/batimatech) jusqu'en mars 2023. De plus, je développe [VueAI.tools](/project/vue-ai-tools) comme projet en parallèle pour le fun.
